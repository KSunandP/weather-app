;(function(CC) {
    CC.Weather = {
        ...
        getTemperatureBand: function(key, array) {

            /*
             *   Iterate over a given array and check whether the given
             *   key is between the lowerLimit and upperLimit
             *   field values and return the corresponding object
             */


            for (var i=0; i < array.length; i++) {
                if (key <= array[i].upperLimit && key >= array[i].lowerLimit) {
                    return array[i];
                }
            }
        },
