(function () {
    ...
    var dataFactories = angular.module('DataFactories', ['ngResource']);

    dataFactories.factory('OpenWeatherMap', ['$resource', OpenWeatherMap]);
    ...
    dataFactories.factory('SunriseSunset', ['$resource', SunriseSunset]);
    ...
    dataFactories.factory('GoogleGeoLoc', ['$resource', GoogleGeoLoc]);
